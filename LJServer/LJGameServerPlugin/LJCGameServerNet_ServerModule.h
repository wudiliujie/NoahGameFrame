...
#include "NFComm/NFPluginModule/LJIGameServerNet_ServerModule.h"
...
class LJCGameServerNet_ServerModule : public LJIGameServerNet_ServerModule
{
public:
	LJCGameServerNet_ServerModule(NFIPluginManager* p)
	{
		pPluginManager = p;
	}
...
protected:
	...
	LJIGameLogicModule * m_pGameLogicModule;
};
